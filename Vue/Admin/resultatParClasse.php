                        ...
                        <div class="box">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table  id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tfoot>
                                        <tr   >
                                            <th colspan="1" class="info"style="font-size: xx-small"> </th>
                                            <th colspan="5" class="warning" style="font-size: xx-small">Nombre de professeur de la classe : </th>
                                            <th colspan="5" class="danger" style="font-size: xx-small"><i class="fa fa-check">   </i> Ultimatum de voix positives</th>
