      ...
      <div class="row">
       <div class="col-md-6">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
                    <form action="admin/exeAddGrid"class="form-horizontal form-label-left" method="post">
                        <div class="box-header with-border">
                            <h3 class="box-title">Ajouter une Grille d'évaluations</h3>
                        </div>
                        <div class="box-body">
                            <br>
                           
                             <div class="input-group">
                                <span class="input-group-addon">Nom de la grille</span>
                                <input name="name" type="text" class="form-control"  required="required">
                            </div>
                            <br>
                             <div class="input-group">
                                <span class="input-group-addon">Catégorie</span>
                                <input name="cat" type="text" class="form-control" required="required">
                            </div>
                            <br>
